...
public class JavaStreams {
	public static void main(String[] args) throws IOException {
		...
		System.out.println("1. Integer Stream range(1,10)");
		IntStream
			.range(1, 10)
			.forEach(System.out::print);

		System.out.println("2. Integer Stream with range(1,10).skip(5)");
		...
		String[] names = {"Abdul", "Amaan", "Kushal", "Brent", "SAK", "Hans", "Sarah"};
		...
		Path pathToFile = Paths.get("bands.txt");
